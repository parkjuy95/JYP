...
public class firepotion : MonoBehaviour
{
    ...
    public float damage;
    public static float firepotionmagicdamage;
    ...
    void attack()
    {
        ...
        if (Target != null && counttime > cooltime)
        {
            ...
            aBullet.GetComponent<firepotionspeed>().targetPosition = (Target.transform.position - transform.position).normalized;
        }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            Instantiate(firepotionobj, collision.transform.position, Quaternion.identity);
