...
public class jijinhee : MonoBehaviour
{
    public float Range;
    ...
    public float damage;
    public static float jijindamage;
    ...
    void attack()
    {
        ...
        if (Target != null && counttime > cooltime)
        {
            ...
            aBullet.GetComponent<jijinheespeed>().targetPosition = (Target.transform.position - transform.position).normalized;
